...
namespace BirdRecogniser02UnitTest
{
    ...
    {
        [TestMethod]
        public async Task Index_ReturnsAViewResult_WithAListOfSubmissions()
        {
        //    // Arrange
        //    var mockContext = new Mock<ApplicationDbContext>();
        //    mockContext.Setup(sub=> sub.ListAsync())
        ...
        //    var controller = new SubmissionsController(mockContext.Object,mockEnv.Object,mockAuth.Object, mockUserManager.Object);
        ...
        //    // Assert
        //   //Assert.IsTypeOf<ViewResult>(result);
